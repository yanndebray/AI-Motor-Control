...
% File name     :   mcb_pmsm_foc_qep_deep_learning_f28379d_data.m
...
if exist('TrainedPosVirtualSensorNet.mat','file')==2
    load('TrainedPosVirtualSensorNet.mat');
    disp('Loading the trained neural network of the position sensor from "TrainedPosVirtualSensorNet.mat"')
elseif exist('DefaultPosVirtualSensorNet.mat','file')==2
    load('DefaultPosVirtualSensorNet.mat');
    disp('Loading the pre-trained neural network of the position sensor from "DefaultPosVirtualSensorNet.mat"')
end